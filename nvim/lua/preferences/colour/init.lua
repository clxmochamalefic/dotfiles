...
local function get_on_terminal()
  ...
  --, get_hl_table("SagaNormal", onepoint_colours_transparent)
  --, get_hl_table("SagaBorder", onepoint_colours_transparent)
  --,
  ...
  ,
    ...
    get_hl_table("RegistersWindow", onepoint_colours_primary)
  , get_hl_table("Pmenu", opc_pmenu)
  , get_hl_table("PmenuSel", opc_pmenu_sel)
  , get_hl_table("PmenuSbar", opc_pmenu_sbar)
  , get_hl_table("PmenuThumb", opc_pmenu_thumb)

  , get_hl_table("NormalFloat", onepoint_colours_secondary)
  , get_hl_table("FloatBorder", onepoint_colours_secondary)
  , get_hl_table("FloatShadow", onepoint_colours_secondary)
  , get_hl_table("FloatShadowThrough", onepoint_colours_secondary)

  , get_hl_table("TermCursor", onepoint_colours_secondary)
  , get_hl_table("TermCursorNC", onepoint_colours_primary)
