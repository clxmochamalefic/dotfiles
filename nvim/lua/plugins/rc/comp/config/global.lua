local sources = require('plugins.rc.comp.config.global.source')
local cmd_sources = require('plugins.rc.comp.config.global.cmdsource')
local option = require('plugins.rc.comp.config.global.option')
local params = require('plugins.rc.comp.config.global.params')
